...
<html lang="pt-br">
    ...
    <section id="conteudo1">
        ...
        <section id="conteudo2">
            <div>
                <img src="img\lateral.jpeg" >
                <p>Analisar seu layout. O ponto de usar o Lorem Ipsum é que ele tem uma distribuição de letras
                     mais ou menos normal, em vez de usar 'Conteúdo aqui, conteúdo aqui'</p>
